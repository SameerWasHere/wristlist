...
export function CollectorCard({
  ...
  return (
    <Link href={href} className="block bg-white rounded-[20px] shadow-[0_1px_4px_rgba(26,24,20,0.04)] border border-[rgba(26,24,20,0.06)] p-5 min-w-[200px] sm:min-w-[220px] hover:shadow-[0_4px_20px_rgba(26,24,20,0.1)] hover:border-[rgba(26,24,20,0.1)] transition-all duration-300 cursor-pointer no-underline text-inherit">
      {/* Avatar + identity */}
